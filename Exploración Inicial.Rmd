...
en la carpeta */ZatsPereiraDosquebradas/* está el archivo gegráfico (formato ESRI shape) de las zonas de análisis de transporte (ZAT) y la zona Urbana de Pereira y Dosquebradas que es donde los análisis de van a enfocar más adelante. Este segundo arhivo fue construído a partir del archivo de [ZATs](https://github.com/orlando-sabogal/Encuesta-Matriz-OD-Pereira-2017/tree/master/BasesDeDatos/ZAT%20Shapefiles)
